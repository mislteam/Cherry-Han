...
class ApiUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.apiuser.index',compact('users'));
    }
    ...
    public function toggleTokenApprove(Request $request,$id,$is_active)
    {
        $user_id=$request->user_id;
        $is_active=$request->is_active;
       // dd($is_active);exit;
        $api_user = ApiUser::where('id',$user_id)->first();
        if($is_active==0){
        return [
            'is_active' => $api_user->toggleTokenApprove(1),
            //'is_active' => 1,
            'created_by' => auth()->id(),
            ];
        }
            ...
            return [
                'is_active' => $api_user->toggleTokenApprove(2),
                'created_by' => auth()->id(),
            ];
        }   
         else if($is_active==2){
    ...
    public function show($id)
    {
        ...
        return view('pages.apiuser.show',compact('apiuser'));
    ...
    public function create(Request $request)
    {
        ...
        $this->validate($request,[
            ...
            'email' => ['required', 'string', 'max:255', 'unique:api_users'],
    ...
    public function edit($id)
    {
        ...
        return view('pages.apiuser.edit',compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request,[
            ...
            'email' => ['required', 'string', 'max:255', 'unique:api_users,email,'.$id],
        ...
        if (auth()->user()->can('api-user.edit'))
            return redirect()->route('apiuserIndex');
        else
