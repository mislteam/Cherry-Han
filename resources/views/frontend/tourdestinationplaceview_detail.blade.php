...
<section class="jumbotron text-center banner_bgimage" style="background: url('../feature/banner/{{$banner}}')top center;background-size: cover;">
    <div class="container mb-4">
      <h3><b style="color:#fff">{{$tourplace->name}}</b></h3>
          ...
          <!-- <div class="col-md-12"> -->
            <div class="col-md-6">
              <div class="post-thumb">
                <img class="w-100" src="{{asset('feature/tourdestinationplace/'.$tourplace->feature_photo)}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="post-meta">
                  ...
                  <dl class="m-t-md">
                    <dd><b><?php echo translate('tour_destination:') ?></b>     {{$tourplace->tourdestination->name}}                   
                      </dd>
                      <dd><b><?php echo translate('tour_destination_place:') ?></b> {{$tourplace->name}}</dd>
                      
                     
                      <dd><b><?php echo translate('description:') ?></b> {{$tourplace->description}}</dd>
                  </dl>
              </div>
            </div>
