...
<section class="jumbotron text-center banner_bgimage" style="background: url('../feature/banner/{{$banner}}')top center;background-size: cover;">
    <div class="container mb-4">
      <h3><b style="color:#fff">Cargo Service</b></h3>
    </div>
</section>
@endif
<div class="content">   
        <div class="row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <div class="card" style="box-shadow: 0 0 40px 0 rgba(100, 100, 100, 0.26) !important;">
                    <a href="{{ route('frontendcargoView', $row->id) }}" class="card-item">
                      <img class="card-img-top" src="{{asset('feature/cargo/'.$row->feature_photo)}}" alt="Card image cap" height="150">
