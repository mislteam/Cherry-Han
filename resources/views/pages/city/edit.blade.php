        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{ route('cityUpdate',$city->id) }}" method="POST" accept-charset="utf-8" class="wizard-big">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            @foreach($countries as $country)
                                                <option value="{{ $country->id }}" <?php if ($country->id==$city->country_id): echo "selected"; ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            @foreach($states as $state)
                                                <option value="{{ $state->id }}" <?php if ($state->id==$city->state_id): echo "selected";?>
