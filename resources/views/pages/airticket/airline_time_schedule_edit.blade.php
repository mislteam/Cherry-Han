            ...
            <div class="ibox col-lg-8 mx-auto">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a href="{{ route('airlineIndex') }}" class="btn btn-sm pt-2 btn-cherryhan" ><i class="fa fa-reply"></i><?php echo translate('back'); ?></a>

                    </div>
                </div>
                <div class="ibox-content">

                    <form action="{{ route('airlineUpdate', $airline->id) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data" class="wizard-big">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('airlineIndex') }}" class="btn btn-default float-right mr-3"><?php echo translate('cancel'); ?></a>
                                    </div>
                                </div>
                            </div>
