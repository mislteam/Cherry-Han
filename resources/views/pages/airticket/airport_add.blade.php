        ...
        <div class="col-lg-12">
            <div class="ibox col-lg-10 mx-auto">
                <div class="ibox-title">
                    <h3>{{ translate('add_new_air_port')}}</h3>
                    <div class="ibox-tools">
                        <a href="{{ route('airportlistIndex') }}" class="btn btn-sm pt-2 btn-cherryhan" ><i class="fa fa-reply"></i><?php echo translate('back'); ?></a>
                    </div>
                </div>
                <div class="ibox-content">

                    <form action="{{ route('airportCreate') }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data" class="wizard-big">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('airportlistIndex') }}" class="btn btn-default float-right mr-3"><?php echo translate('cancel'); ?></a>
                                    </div>
                                </div>
                            </div>
