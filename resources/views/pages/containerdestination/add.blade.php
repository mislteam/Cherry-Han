        ...
        <div class="col-lg-12">
            <div class="ibox col-lg-10 mx-auto">
                <div class="ibox-title">
                    <h5><?php echo translate('add_new_container_destination'); ?> </h5>
                    @can('car.view')
                ...
                <div class="ibox-content">
                    <form action="{{ route('containerdestinationCreate') }}" method="post">
                        @csrf                   
                        <div class="form-group {{ $errors->has('name') ? 'has-error':'' }}">
                            <label class=" col-form-label"><?php echo translate('container_destination_name_*'); ?></label>
                            <div class="">
                                <input type="text" name="name" placeholder="<?php echo translate('placehoder_destination_name') ?>" class="form-control" required>
