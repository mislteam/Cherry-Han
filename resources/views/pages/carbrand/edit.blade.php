        ...
        <div class="col-lg-12">
            <div class="ibox col-lg-8 mx-auto">
                ...
                <div class="ibox-content">
                    <form action="{{ route('carbrandUpdate', $carbrand->id) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group row {{ $errors->has('name') ? 'has-error':'' }}">
                            <label class="col-sm-4 col-form-label"><?php echo translate('car_brand_name'); ?></label>
                            <div class="col-sm-8">
                                <input type="text" name="name" value="{{ old('name', $carbrand->name) }}" placeholder="<?php echo translate('placeholder_car_name') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('seo_title') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="seo_title" value="{{ old('name', $carbrand->seo_title) }}" placeholder="<?php echo translate('seo_title') ?>"  class="form-control">
