                ...
                <div class="ibox-content">
                    <form action="{{ route('permissionUpdate', $permission->id) }}" method="post">
                        ...
                        <div class="form-group row {{ $errors->has('name') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" placeholder="<?php echo translate('placehoder_permission_name') ?>" class="form-control" value="{{ old('name', $permission->name) }}">
                        ...
                        <div class="form-group row {{ $errors->has('title') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title"  placeholder="<?php echo translate('placehoder_permission_title') ?>" class="form-control" value="{{ old('title', $permission->title) }}">
