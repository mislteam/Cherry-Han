        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{ route('tourcategoryCreate') }}" method="POST" accept-charset="utf-8" class="wizard-big">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" placeholder="<?php echo translate('placeholder_tour_category_name') ?>" class="form-control {{ $errors->has('name') ? 'is-invalid':'' }}" value="{{ old('name') }}" required>
