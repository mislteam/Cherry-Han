        ...
        <div class="col-lg-12">
            <div class="ibox col-lg-6 mx-auto">
                <div class="ibox-title">
                    <h5><?php echo translate('edit_admin_user'); ?></h5>
                ...
                <div class="ibox-content">
                    <form action="{{ route('userUpdate', $user->id) }}" method="post">
                        ...
                        <div class="form-group row {{ $errors->has('name') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" placeholder="<?php echo translate('placehoder_user_name') ?>" class="form-control" value="{{ old('name', $user->name) }}">
                        ...
                        <div class="form-group row {{ $errors->has('email') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="email"  placeholder="<?php echo translate('placehoder_user_email') ?>" class="form-control" value="{{ old('email', $user->email) }}">
