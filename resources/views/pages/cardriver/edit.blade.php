        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><?php echo translate('edit_new_car_driver'); ?></h5>
                    @can('car.view')
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('cardriverUpdate',$cardriver->id) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                            @csrf
                                <div class="form-group row {{ $errors->has('name') ? 'has-error':'' }}">
                                    <label class="col-sm-4 col-form-label"><?php echo translate('car_driver_name_*'); ?></label>
                                    <div class="col-sm-8">
                                        <input type="text" name="name" value="{{$cardriver->name}}" placeholder="<?php echo translate('placeholder_car_driver_name') ?>"  class="form-control" required>
                                ...
                                <div class="form-group row {{ $errors->has('phone') ? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="phone" value="{{$cardriver->phone}}" placeholder="<?php echo translate('placeholder_driver_phone') ?>"  class="form-control" required>
                                ...
                                <div class="form-group row {{ $errors->has('email') ? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="email" type="email" value="{{$cardriver->email}}" placeholder="<?php echo translate('placeholder_car_driver_email') ?>" class="form-control" required> 
                                ...
                                <div class="form-group row {{ $errors->has('age') ? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="age" type="age" value="{{$cardriver->age}}" placeholder="<?php echo translate('placeholder_car_driver_age') ?>" class="form-control" required> 
                                        @if($errors->has('age') || 1)
                                ...
                                <div class="form-group row col-form-label {{ $errors->has('gender') ? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8 d-flex">
                                    	@foreach($gender as $key=>$val)
                                            <div class="i-checks pr-2"><label> <input type="radio" value="{{ $key }}" name="gender" <?php echo ($val == $cardriver->gender)?"checked":""; ?>> <i></i> {{ ucwords($val) }} </label></div>
                                        @endforeach
                                    ...
                                    <div class="col-sm-8">
                                        <select  name="country_id" id="country_id" class="form-control select2_demo_1" data-live-search="true" placeholder="<?php echo translate('placeholder_country') ?>" required>
                                            ...
                                            @foreach($countries as $country)
                                                <option value="{{ $country->id }}" <?php if ($country->id==$cardriver->country_id): echo "selected"; ?>
                                    ...
                                    <div class="col-sm-8">
                                        <select  name="state_id" id="state_id" class="form-control select2_demo_1" data-live-search="true" placeholder="<?php echo translate('placeholder_state') ?>" required>
                                            ...
                                            @foreach($states as $state)
                                                <option value="{{ $state->id }}" <?php if ($state->id==$cardriver->state_id): echo "selected"; ?>
                                    ...
                                    <div class="col-sm-8">
                                        <select  name="city_id" id="city_id" class="form-control select2_demo_1" data-live-search="true" placeholder="<?php echo translate('placeholder_city') ?>" required>
                                            ...
                                            @foreach($cities as $city)
                                                <option value="{{ $city->id }}" <?php if ($city->id==$cardriver->city_id): echo "selected"; ?>
                                ...
                                <div class="form-group row {{ $errors->has('address') ? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="address" value="{{$cardriver->address}}" placeholder="<?php echo translate('placeholder_car_driver_address') ?>"  class="form-control" required>
                                ...
                                <div class="form-group row {{ $errors->has('license_type') ? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="license_type" value="{{$cardriver->license_type}}" placeholder="<?php echo translate('placeholder_car_driver_license') ?>"  class="form-control" required>
                                ...
                                <div class="form-group row {{ $errors->has('tour_exp') ? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="tour_exp" value="{{$cardriver->tour_exp}}" placeholder="<?php echo translate('placeholder_driver_tour_exp') ?>"  class="form-control" required>
                                ...
                                <div class="form-group row {{ $errors->has('drive_exp') ? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="drive_exp" value="{{$cardriver->drive_exp}}" type="text" placeholder="<?php echo translate('placeholder_car_driver_exp') ?>" class="form-control" required> 
                                    ...
                                    <div class="col-sm-8">
                                        <table class="table">
                                            ...
                                            <tbody id="kpi-setdata">
                                                <?php
                                                    $language = json_decode($cardriver->language, true);
                                                    foreach($language as $key =>$val){
                                                ?>
                                                <tr>
                                                    <td class="col-lg-6">
                                                        <input class="form-control " name="language[]" value="{{$val}}" type="text" placeholder="<?php echo translate('language'); ?>">
                                                    </td>
