...
@section('content')
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>@lang('cruds.category.title')</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('cruds.category.title_singular')</h3>
                            @can('category.add')
                            <a href="{{ route('sub_sub_categoryAdd') }}" class="btn btn-success btn-sm float-right">
                                ...
                                @foreach($lists as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @can('category.delete')
                                            <form action="{{ route('sub_sub_categoryDestroy',$row->id) }}" method="post">
                                                @csrf
                                                <div class="btn-group">
                                                    @can('roles.edit')
                                                        <a href="{{ route('sub_sub_categoryEdit',$row->id) }}" type="button" class="btn btn-info btn-sm"> @lang('global.edit')</a>
                                                    @endcan
