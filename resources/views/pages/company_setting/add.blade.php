        ...
        <div class="col-lg-12">
            <div class="ibox col-lg-8 mx-auto">
                <div class="ibox-title">
                    <h5><?php echo translate('add_company_setting'); ?></h5>
                    @can('car-type.view')
                ...
                <div class="ibox-content">
                    <form action="{{ route('companysettingCreate') }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group row {{ $errors->has('name') ? 'has-error':'' }}">
                            <label class="col-sm-2 col-form-label"><?php echo translate('company_name_*'); ?></label>
                            <div class="col-sm-10">
                                <input type="text" name="name" placeholder="<?php echo translate('placeholder_company_name') ?>"  class="form-control" required>
                        ...
                        <div class="form-group row {{ $errors->has('logo') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="logo" class="form-control {{ $errors->has('logo') ? 'is-invalid':'' }}" required>
