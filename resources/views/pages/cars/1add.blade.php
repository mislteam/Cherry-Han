        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form action="{{ route('carsCreate') }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group row {{ $errors->has('width') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="width" placeholder="<?php echo translate('placeholder_car_body_width') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('height') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="height" placeholder="<?php echo translate('placeholder_car_body_height') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('trip_type') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="trip_type" placeholder="<?php echo translate('placeholder_trip_type') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('day_type') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="day_type" placeholder="<?php echo translate('placeholder_day_type') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('seat_no') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="seat_no" placeholder="<?php echo translate('placeholder_seat_no') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('ac') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10 d-flex">
                                <div class="i-checks pr-2"><label> <input type="radio" value="yes" name="ac" checked> <i></i> Yes </label></div>
                                <div class="i-checks pl-2"><label> <input type="radio" value="no" name="ac"> <i></i> No </label></div>
                                @if($errors->has('ac') || 1)
                        ...
                        <div class="form-group row {{ $errors->has('abs') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10 d-flex">
                                <div class="i-checks pr-2"><label> <input type="radio" value="yes" name="abs" checked> <i></i> Yes </label></div>
                                <div class="i-checks pr-2"><label> <input type="radio" value="no" name="abs"> <i></i> No </label></div>
                                @if($errors->has('abs') || 1)
                        ...
                        <div class="form-group row {{ $errors->has('airbag') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10 d-flex">
                                <div class="i-checks pr-2"><label> <input type="radio" value="yes" name="airbag" checked> <i></i> Yes </label></div>
                                <div class="i-checks pr-2"><label> <input type="radio" value="no" name="airbag"> <i></i> No </label></div>
                        ...
                        <div class="form-group row {{ $errors->has('service') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10" >
                            	<input type="text" name="service" placeholder="<?php echo translate('placeholder_service') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('no_of_laggage') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="no_of_laggage" placeholder="<?php echo translate('placeholder_laggage') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('wheel_drive') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="wheel_drive" placeholder="<?php echo translate('placeholder_wheel_drive') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('license_type') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="license_type" placeholder="<?php echo translate('placeholder_license_type') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('driver_id') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="driver_id" placeholder="<?php echo translate('placeholder_driver_name') ?>"  class="form-control">
                        ...
                        <div class="form-group row {{ $errors->has('ownner_id') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                            	<input type="text" name="ownner_id" placeholder="<?php echo translate('placeholder_ownner_name') ?>"  class="form-control">
