        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><?php echo translate('language_list'); ?></h5>
                    @can('car.add')
                                    ...
                                    <td class="text-center">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                @can('language.edit')
                                                    ...
                                                    <a href="{{URL('/language/edit/'.$language->word_id.'/'.'language')}}" type="button" class="btn btn-info btn-sm pt-2"> <?php echo translate('edit') ?></a>
                                                @endcan
