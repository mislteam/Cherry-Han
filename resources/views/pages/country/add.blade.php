        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{ route('countryCreate') }}" method="POST" accept-charset="utf-8" class="wizard-big">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="phcode" class="form-control {{ $errors->has('phcode') ? 'is-invalid':'' }}" value="{{ old('phcode') }}" required>
