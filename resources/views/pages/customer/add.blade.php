            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('apiuserIndex') }}">API @lang('cruds.user.title')</a></li>
            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('apiuserCreate') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                <label>@lang('cruds.user.fields.token_exp_date')</label>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('apiuserIndex') }}" class="btn btn-default float-left">@lang('global.cancel')</a>
                            </div>
                        </form>
