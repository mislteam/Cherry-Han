        ...
        <div class="col-lg-12">
            <div class="ibox col-lg-6 mx-auto">
                <div class="ibox-title">
                    <h5><?php echo translate('edit_category'); ?></h5>
                    @can('car.view')
                ...
                <div class="ibox-content">
                    <form action="{{ route('categoryUpdate', $category->id) }}" method="post">
                        ...
                        <div class="form-group row {{ $errors->has('name') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" placeholder="<?php echo translate('placehoder_category_name') ?>" class="form-control" value="{{ old('name', $category->name) }}">
                        ...
                        <div class="form-group row {{ $errors->has('type') ? 'has-error':'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="type" placeholder="<?php echo translate('placehoder_category_type') ?>" class="form-control" value="{{ old('type', $category->type) }}">
