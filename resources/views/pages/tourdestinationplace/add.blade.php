        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h3><?php echo translate('add_new_tour_destination_place'); ?></h3>
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{ route('tourdestinationplaceCreate') }}" method="POST" accept-charset="utf-8" class="wizard-big" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label><?php echo translate('tour_destination_place_name*') ?></label>
                                        <input type="text" name="name" placeholder="<?php echo translate('placeholder_tour_destination_place') ?>" class="form-control {{ $errors->has('name') ? 'is-invalid':'' }}" value="{{ old('name') }}" required>
                                    ...
                                    <div class="form-group {{ $errors->has('description
                                        ') ? 'is-invalid':'' }}">
                                        <label><?php echo translate('description_*') ?></label>
                                        <textarea name="description" class="form-control" placeholder="<?php echo translate('placeholder_description') ?>" required></textarea>
