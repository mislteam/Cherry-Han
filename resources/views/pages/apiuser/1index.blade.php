                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @can('user.add')
                            <a href="{{ route('apiuserAdd') }}" class="btn btn-success btn-sm float-right">
            ...
            $.ajax({
                ...
                success: function(result){
                    if (result.is_active == 1){
                        $("#api_user_"+id).attr('class',"fa fa-check-circle text-success");
                    }
                    else
                    {
                        $("#api_user_"+id).attr('class',"fa fa-times-circle text-danger");
                    }
                },
