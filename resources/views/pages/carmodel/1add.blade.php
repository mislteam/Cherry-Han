            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('carmodelIndex') }}">@lang('form.carmodel.title')</a></li>
            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('carmodelCreate') }}" method="post">
                            @csrf

                            <div class="form-group">
                                <label>@lang('form.carmodel.name.label')</label>
                                <input type="text" name="name" placeholder="@lang('form.carmodel.name.placeholder')" class="form-control" value="{{ old('name') }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="seo_title" placeholder="@lang('form.carmodel.slug.placeholder')" class="form-control" value="{{ old('seo_title') }}">
                            </div>
                            <div class="form-group ">
